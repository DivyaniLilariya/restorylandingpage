      ...
      <footer className=" text-center text-neutral-600 bg-blue-900 dark:text-neutral-200 lg:text-left">
        ...
        <div className="flex items-center  justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between">
          ...
          <div className="flex justify-center">
            <a href="https://www.facebook.com/restoryhealthytech/" className="mr-6 text-neutral-600  hover:bg-red-500 hover:p-1 hover:rounded-lg dark:text-neutral-200">
              <svg
            ...
            <a  href="https://twitter.com/RestoryH"  className="mr-6 text-neutral-600  hover:bg-red-500 hover:p-1 hover:rounded-lg dark:text-neutral-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
                fill="currentColor"
            ...
            <a href="https://www.instagram.com/" className="mr-6 text-neutral-600  hover:bg-red-500 hover:p-1 hover:rounded-lg dark:text-neutral-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
                fill="currentColor"
            ...
            <a  href="https://www.linkedin.com/company/restory-healthytech/mycompany/" className="mr-6 hover:bg-red-500 hover:p-1 hover:rounded-lg text-neutral-600 dark:text-neutral-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
                fill="currentColor"
