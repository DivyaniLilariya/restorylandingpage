...
const BodySectionThree = () => {
  return (
    <div style={{ backgroundColor: "#6f42c1" }} className='flex  flex-col md:flex-row md:flex-wrap justify-around py-8 md:py-8 sm:py-8 lg:py-8 xl:py-8 2xl:py-8'>
      <div className='w-full md:w-80 lg:w-96 mb-8 md:mb-0 p-4'>
        ...
        <p className="text-justify  text-white font-['Poppins']">This is done at the convenience of their house or workplace based on employee requirement and organizational policy. The report comes as a overall score which is measurable and repeatable enabling comprehensive tracking of their health as a whole and for individual body systems</p>
      </div>
      <div className='w-full md:w-80 lg:w-96 mb-8 md:mb-0 p-4'>
        ...
        <p className="text-justify  text-white font-['Poppins']">Early identification of medical, social and nutritional challenges and risks such as cardiac health, bone health, Gut health, brain health, kidney and liver health are provided</p>
      </div>
      <div className='w-full md:w-80 lg:w-96 p-4'>
        ...
        <p className="text-justify  text-white font-['Poppins']">Early identification of issues impacting quality of life, wellness and nutrition and trackable and measurable health insights will improve their productivity and satisfaction</p>
      </div>
    </div>
  );
}
