...
const About = () => {
  return (
    <div className="flex justify flex-wrap justify-around p-9"  style={{ marginTop: "90px" }}>
      <div>
        <img src={aboutus} className="h-auto "  height="600" width="500"
      ...
      <div className="w-1/2 m-4">
        <div className="">
          ...
          <h1 className="text-4xl font-bold overflow-hidden">WHO ARE WE</h1>
        </div>
        <div className="my-4">
          <p className="text-justify text-lg w-md">
