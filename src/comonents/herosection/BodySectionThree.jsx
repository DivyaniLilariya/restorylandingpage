...
const BodySectionThree = () => {
  return (
    <div  style={{backgroundColor:"#6f42c1" ,height:"90vh" }}  className=' flex flex-row justify-around py-32' >
      <div className='w-1/4'>
          ...
          <div><p className='text-justify te
          xt-white'>This is done at the convenience of their house or workplace based on employee requirement and organizational policy. The report comes as a overall score which is measurable and repeatable enabling comprehensive tracking of their health as a whole and for individual body systems</p></div>
      </div>
      <div className='w-1/4'>
