    ...
    <div style={{ marginTop: "80px" }}>
      ...
      <div className="mx-4 sm:mx-8 md:mx-16 my-10 sm:my-10">
        ...
        <ol className="space-y-1 pl-8 list-decimal list-inside">
          ...
          <li className="font-['Poppins']">150 Lifestyle and Functional parameters for identifying health risks</li>
      ...
      <div>
        <h3 className="text-2xl text-center overflow-hidden font-bold font-['Poppins'] dark:text-gray-800 uppercase">
          To request for a sample report and brochure copy call us on +91 80082 47365
        </h3>

        <div className="flex flex-wrap px-4 sm:px-8 md:px-16 my-10 sm:my-16 justify-around">
          <div className="border-2 w-full sm:w-80 md:w-96 rounded-md h-auto p-4 mb-8 sm:mb-10" style={{ overflow: "hidden" }}>
            <div className="">
              <img src={lyftrac} className="h-24 mb-4 w-full border-b-2" alt="image loading" />
            </div>
            <div className="w-full px-3 sm:px-9">
              ...
              <p className="text-justify font-normal font-['Poppins'] text-gray-700">
                A Comprehensive and holistic health assessment using medical and lifestyle data. It assesses pathological values, physiological parameters, nutritional status, physical and emotional health to develop a personalised and proprietary LyfTrac Score to help improve your quality of life.
              </p>
            </div>
          </div>

          <div className="border-2 w-full sm:w-80 md:w-96 rounded-md h-auto p-4 mb-8 sm:mb-10">
            <div>
